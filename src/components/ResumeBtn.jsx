...
export default function ResumeBtn() {
  ...
  return (
    <a href="/cv.pdf" download="Julian_Mena_CV" className={`${hidden && "opacity-0"} transition-opacity duration-1000 fixed bottom-3 left-2 text-sm bg-orange-600 dark:bg-purple-600 text-white font-bold rounded-md shadow-lg flex items-center p-2 lg:text-base lg:bottom-10 lg:left-10 lg:px-3 z-10`}>
